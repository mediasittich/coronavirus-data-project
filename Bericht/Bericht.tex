...
\usepackage{multibib}
\newcites{Urls}{Datenquellen}
\newcites{RPackages}{Verwendete R Pakete}
\newcites{PythonPackages}{Verwendete Python Pakete}
...
\bibliographystyleRPackages{plain}
\bibliographystylePythonPackages{plain}
...
\bibliographyRPackages{RPackages}
\bibliographyPythonPackages{PythonPackages}
